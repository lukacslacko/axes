...
for fi,f in enumerate(A['families']):
 ...
 for vi,v in sorted(enumerate(f['variants']),key=lambda x:x[1]['angle']):
  ...
  if v['rays']>7:note+=' · exceeds 7 directed axes'
  ...
  cards.append(f'''<article class="puzzle" id="{ident}" data-family="{fi}" data-variant="{vi}">
    ...
    <canvas width="440" height="360" tabindex="0" role="img" aria-label="{html.escape(name)}, {title}, {angle}. Drag or use arrow keys to rotate; tap a piece to highlight its class."></canvas>
...
<p class="read-more"><a href="https://github.com/lukacslacko/axes/blob/main/docs/model.md">Mathematical catalogue ↗</a><a href="https://github.com/lukacslacko/axes/blob/main/docs/reachability.md">Reachability calculation ↗</a><a href="https://github.com/lukacslacko/axes">Code &amp; reproducible data ↗</a></p></section>
